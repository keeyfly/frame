...
import com.mylibrary.util.StringHelper;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private String mRefreshFailedKey;
    ...
    public void setRefreshFailedKey(String key) {
        mRefreshFailedKey = key;
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mProgressBar.setVisibility(INVISIBLE);
        mTitleTextView.setVisibility(VISIBLE);
        if (!StringHelper.isNull(mRefreshFailedKey))
            mTitleTextView.setText(mRefreshFailedKey);
        else
