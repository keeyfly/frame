...
public class PtrRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (PtrRecyclerAdapter.this.onItemClickListener != null) {
                PtrRecyclerAdapter.this.onItemClickListener.onItemClick(PtrRecyclerAdapter.this, vh, position);
            }
    ...
    private class MyOnLongClickListener implements OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            int position = getRealPosition(vh.getLayoutPosition());
            if (PtrRecyclerAdapter.this.onItemLongClickListener != null) {
                PtrRecyclerAdapter.this.onItemLongClickListener.onItemLongClick(PtrRecyclerAdapter.this, vh,
                        position);
            }
    ...
    public static interface OnItemClickListener {
        void onItemClick(PtrRecyclerAdapter adapter, RecyclerView.ViewHolder vh, int position);
    }

    public static interface OnItemLongClickListener {
        void onItemLongClick(PtrRecyclerAdapter adapter, RecyclerView.ViewHolder vh, int position);
    }

    private RecyclerView.Adapter<RecyclerView.ViewHolder> mAdapter;

    public PtrRecyclerAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        super();
